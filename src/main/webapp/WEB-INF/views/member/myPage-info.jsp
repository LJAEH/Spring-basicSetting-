            ...
            <section class="myPage-main">
                ...
                <form action="info" method="POST" name="myPage-form" onsubmit="return infoValidate()">
                    ...
                    <div class="myPage-row">
                        <label>닉네임</label>
                        <input type="text" name="updateMemberNickname"  id="memberNickname"  value="${loginMember.memberNickname}" maxlength="10">              
                    </div>

                    <div class="myPage-row">
                        <label>전화번호</label>
                        <input type="text" name="updateMemberTel"  id="memberTel" value="${loginMember.memberTel}" maxlength="11">
                    </div>
